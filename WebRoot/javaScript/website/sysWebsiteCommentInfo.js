$(function(){ 
	$.supper('initUpFile',{id:"uploadButton_s",codeId:"newsIconFileCode"}); 
	$.supper('initUpFile',{id:"uploadButton_plus",codeId:"newsIllustratedFileCode"}); 

	$.supper('initUpFile',{id:"uploadButton_news01",codeId:"newPictureFilecode01"}); 
	$.supper('initUpFile',{id:"uploadButton_news02",codeId:"newPictureFilecode02"}); 
	$.supper('initUpFile',{id:"uploadButton_news03",codeId:"newPictureFilecode03"}); 
	KindEditor_init(); 
});
...
function validate(){
	...
	var createRen = $("#createRen").val();
	var newsComment = $("#newsComment").text();
