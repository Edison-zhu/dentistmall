$(function(){ 
	initOneUploadImg("newsIconFileCode","newsIconFileCodeDiv");
	KindEditor_init(); 
});
...
function validate(){
	...
	var newsIconFileCode = $("#newsIconFileCode").val();
	var serialNumber = $("#serialNumber").val();
	 ...
	 if(CheckUtil.isNull(newsIconFileCode)){
		 Messager.info("请上传轮播图片!");
		 return false;
	 }
