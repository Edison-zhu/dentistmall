...
var _saveForm={ 
		...
		hiddenitems:[
						...
						{name:"orgGxId",id:"orgGxId",value:"",type:"hidden"},  
						{name:"logoCode",id:"logoCode",value:"",type:"hidden"},  
		...
		items:[ 
		       	...
		       	{title:'企业名称', name:'applicantName', placeholder:"企业名称",ariaRequired:true}, 
			...
			"BackE" : function(jsondata) {
				if (jsondata.code == "1") {
					$.supper("alert", {
						...
						BackE : function(){
							if(_rbbId ==null || _rbbId==""){
								_rbbId = jsondata.obj.wzId;
								$("#wzId").val(jsondata.obj.wzId);
								$("#orgGxId").val(jsondata.obj.orgGxId);
...
function openSalesMan() {
	...
	$.supper("setProductArray", {"name":"excluldeId", "value":{hideType: true, excludeTypes: "1,2"}});
