...
var _dd_search_action = 'ShoppingService.findOrderAfterSaleBySearch';
var moiId = null;
...
$(function () {
    ...
    $.supper('initPagination', {
        id: "Pagination",
        service: "ShoppingService.getOrderAfterSalePager",
    ...
    initOderListUtil({server: 'ShoppingService.getOrderAfterSaleMxModelByMasId'});
...
function initList(dataList) {
    initOderAsList('divList', dataList, true);
}

function initCount() {
    var vdata = 'moiId=' + moiId;
    $.supper("doservice", {
        "service": "ShoppingService.countOrderAfterSale", data: vdata, "BackE": function (jsondata) {
            if (jsondata.code == "1") {
