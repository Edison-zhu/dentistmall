...
var _all_queryAction = "MdDentalClinicService.getPagerModelObject";
var _all_deleteAction = "MdDentalClinicService.deleteObject";
var _all_deleteAllAction = "MdDentalClinicService.deleteAllObject";
var _verify_pass = 'MdDentalClinicService.updateVerify';

var _all_win_datagrid;
var _all_win_url_edit = "/jsp/dentistmall/business/updateDentalClinic.jsp";
var _all_table_Id = "rbbId";
var _all_edit_icon = "gears";
var _all_edit_title = "门诊维护";
var _all_edit_width = 800;
var _all_edit_height = 700;
var _all_datagrid_height ;
var _dblClick = function (data, row, col) {
	main_edit(data.rbbId);
}
...
var _searchForm={ 
		...
		groupTag:[], 
		items:[ 
			   {title:"门诊编号",name:"rbbCode",type:"text",placeholder:"门诊编号"}, 
			   {title:"门诊名称",name:"rbbName",type:"text", placeholder:"门诊名称"}
		]	
	}
...
var _DataGrid = {
	cols: [
		{title: '门诊编号', sortable: true, name: 'rbbCode', width: 80, align: 'center'},
		{title: '门诊名称', sortable: true, name: 'rbbName', width: 80, align: 'center'},
		{title: '业务员(姓名/电话)', sortable: true, name: 'salesName', width: 80, align: 'center', renderer: initSalesMan},
		{title: '所在省', sortable: true, name: 'province', width: 50, align: 'center'},
		{title: '所在市', sortable: true, name: 'city', width: 50, align: 'center'},
		{title: '所在地区', sortable: true, name: 'area', width: 50, align: 'center'},
		{title: '负责人', sortable: true, name: 'connUser', width: 50, align: 'center'},
		{title: '电话', sortable: true, name: 'connPhone', width: 80, align: 'center'},
	...
	if (item.verifyState != undefined && item.verifyState != null && item.verifyState != '') {
		if (item.verifyState == "1") {
			if (_user_type != undefined && _user_type != null && _user_type == '6') {
				...
				str += "<a class='btn btn-warning  btn-xs' onclick='verifyObj(\"" + idvalue + "\", \"" + item.rbbCode + "\", \"" + item.rbaName + "\")'>审核</a>&nbsp;&nbsp;";
			}
...
function main_addUser(id){ 
	...
	var att_title="管理员维护"
	var att_userType="1"
	var data= "organizaType=20003&oldId="+id+"&userType="+att_userType+"&applicantName=" +att_title; 
