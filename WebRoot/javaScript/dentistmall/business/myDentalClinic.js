...
var _saveForm={
		...
		items:[ 
		       	...
		       	{title:'所属集团公司名称', name:'rbaName',"readOnly":"true"},
		       	{title:'所属医院名称', name:'rbsName',"readOnly":"true"},
		       	{title:'门诊名称', name:'rbbName', placeholder:"门诊名称","readOnly":"true"},
...
function cleanFormWin(){ 
	...
	_rbsId=top.window._win_main_orgGxId?top.window._win_main_orgGxId:"";	
	_rbsName=top.window._win_main_orgName?top.window._win_main_orgName:"";
