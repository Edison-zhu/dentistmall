...
var _all_queryAction = "MdDentistHospitalService.getPagerModelObject";
var _all_deleteAction = "MdDentistHospitalService.deleteObject";
var _all_deleteAllAction = "MdDentistHospitalService.deleteAllObject";
var _verify_pass = 'MdDentistHospitalService.updateVerify';

var _all_win_datagrid;
var _all_win_url_edit = "/jsp/dentistmall/business/updateDentistHospital.jsp";
var _all_table_Id = "rbsId";
var _all_edit_icon = "gears";
var _all_edit_title = "医院维护";
var _all_edit_width = 800;
var _all_edit_height = 700;
var _all_datagrid_height ;
var _dblClick = function (data, row, col) {
	main_edit(data.rbsId);
}
...
var _searchForm={ 
		...
		groupTag:[], 
		items:[ 
			   {title:"医院编号",name:"rbsCode",type:"text",placeholder:"医院编号"}, 
			   {title:"医院名称",name:"rbsName",type:"text", placeholder:"医院名称"}
		]	
	}
...
var _DataGrid = {
	cols: [
		{title: '医院编号', sortable: true, name: 'rbsCode', width: 80, align: 'center'},
		{title: '医院名称', sortable: true, name: 'rbsName', width: 80, align: 'center'},
		...
		{title: '负责人', sortable: true, name: 'legalPerson', width: 50, align: 'center'},
		{title: '电话', sortable: true, name: 'legalPhone', width: 80, align: 'center'},
	...
	if (item.verifyState != undefined && item.verifyState != null && item.verifyState != '') {
		if (item.verifyState == "1") {
			if (_user_type != undefined && _user_type != null && _user_type == '6') {
				...
				str += "<a class='btn btn-warning  btn-xs' onclick='verifyObj(\"" + idvalue + "\", \"" + item.rbsCode + "\", \"" + item.rbaName + "\")'>审核</a>&nbsp;&nbsp;";
			}
