...
var _all_saveAction = "MdDentalClinicService.saveOrUpdateObject";
var _all_questAction = "MdDentalClinicService.findFormObject";
var _saveForm={
		renew:true,
		lineNum:14,
		columnNum:1,
		...
		items:[
			{title: '门诊图标', name: 'logo', type: 'userdefined', renderer: upLogo},
		       	{title:'门诊编号', name:'rbbCode', placeholder:"门诊编号","readOnly":"true","prefixCode":"YMZ"},  
		       	{title:'所属集团公司名称', name:'rbaName',placeholder:"所属集团公司名称","readOnly":"true"},
		       	{title:'所属医院名称', name:'rbsName',placeholder:"所属医院名称","readOnly":"true"},
		       	{title:'门诊名称', name:'rbbName', placeholder:"门诊名称","ariaRequired":"true"},
		    	{title:'门诊地址', name:'address', placeholder:"门诊地址"},  
		    	...
		    	{title:'负责人', name:'connUser', placeholder:"负责人"}, 
		    	{title:'手机号', name:'connPhone', placeholder:"手机号"},
			...
			// bindYWYText(),
			{title: '绑定业务员', name: 'salesName', placeholder: '绑定业务员', type: 'userdefined', renderer: bindYWY}
...
function initForm(){	
	...
	_all_accountForm.xform('loadAjaxForm',{'ActionUrl':_all_questAction,"data":att_data,"BackE":function(data){
		_rbsId=data.obj.rbsId;
		_rbaId=data.obj.rbaId;
		_rbsName=data.obj.rbsName;
