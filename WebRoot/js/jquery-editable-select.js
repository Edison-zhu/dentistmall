...
+(function ($) {
	...
	EditableSelect.prototype.reset = function () {
		// this.$list.find('li').remove();
		// this.$select.find('option').remove();
		// this.$input.val('');
		this.filter();
		...
		that.es.$input.on('input keydown', function (e) {
			switch (e.keyCode) {
				...
				case 13: // Enter �Զ��巽��
					...
					// 	e.preventDefault();
					// }
					if(that.es.options.keyEnter !== undefined && that.es.options.keyEnter !== null && typeof that.es.options.keyEnter == 'function') {
						that.es.options.keyEnter();
					}
					break;
				case 9:  // Tab
				case 27: // Esc
