        ...
        <div class="panel-body scrollbarinfo">
            ...
            <div class="ibox float-e-margins" style="border:1px solid #e7eaec;margin-top:5px">
                ...
                <div class="ibox-title"
                     style="border-bottom:1px solid #e7eaec;border-top:0px;min-height:38px;margin-bottom:10px">
                    <!-- 标题文字区域begin -->
...
<script src="<c:url value='/javaScript/dentistmall/storage/viewApplyMdOutWarehouser.js?v=24'/>"></script>