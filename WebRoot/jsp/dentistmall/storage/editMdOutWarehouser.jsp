...
<!-- 表单部分begin -->
				...
				<div class="ibox float-e-margins" style="border:1px solid #e7eaec;margin-top:5px">
	                  <!--标题栏区域 begin-->
	                     <div class="ibox-title" style="border-bottom:1px solid #e7eaec;border-top:0px;min-height:45px;margin-bottom:10px">
	                    	<!-- 标题文字区域begin -->
	                        <h5>&nbsp&nbsp出库明细列表</h5> 
	                        <!-- 标题文字区域end -->
	                        <div class="ibox-tools">
	                        	<button type="button" class="btn btn-success btn-xs" id="selInvBut" style="display:none"  onclick="selInv();"><i class="fa fa-edit"></i>选择</button>
							</div> 
	                    </div>
	                    <div id="gridDiv">
	...
	<script src="<c:url value='/javaScript/dentistmall/storage/editMdOutWarehouser.js?v=23'/>"></script>