			...
			<div class="panel-body scrollbarinfo">
				...
				<div class="form-inline form-group">
					<div class="controls col-sm-5" style="font-size:15px">
						申领单号:
						<input type="text" class="form-control" placeholder="申领单号" name="mooCode" value="" style="width:120px">
					</div>
					<div class="controls col-sm-5" style="font-size:15px">
						申领人:
						<input type="text" class="form-control" placeholder="申领人" name="userName" value="" style="width:120px">
					</div>
					<div class="controls col-sm-2 text-right">
						<a class="btn btn-success btn-xs" onclick="vsearch();">查询</a>
					</div>
				</div>
...
<script src="<c:url value='/javaScript/dentistmall/storage/selOutOrderList.js?v=32'/>"></script>