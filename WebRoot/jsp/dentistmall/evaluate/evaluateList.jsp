	...
	<div class="wrapper wrapper-content animated fadeInRight ">
		    <!-- 标题栏区域 begin-->
						<div class="ibox-title">
							<!-- 标题文字区域begin -->
							<h5>
								<i class="fa fa-flask"></i>&nbsp&nbsp<span>评价信息</span> 
							</h5>
							<!-- 标题文字区域end --> 
						...
						<div class="ibox-content" style="padding: 5px 10px 10px;">
							...
							<div  id="win_form_hidden" ><input type="hidden"   value="" name="mmfCode" id="mmfCode" /> </div>
							</form>
						</div>
						<!-- 查询区域end -->
...
<script src="<c:url value='/javaScript/dentistmall/evaluate/evaluateList.js?v=20'/>"></script>
