...
<html>
  <head> 
   <title>AI平台系统</title> 
 	...
 	<script src="<c:url value='/javaScript/dentistmall/transaction/viewCgyorderInfo.js?v=19'/>"></script>
  </head> 
  <body class="gray-bg">
    <div class="wrapper wrapper-content animated fadeInRight">
		<div class="ibox-title">
			...
			<div class="ibox-tools" id="win_tools_but"   > 
				<a onclick="main_export()"  class='btn btn-success  btn-xs' style="color:#fff">导出详情</a>
			</div>
		</div>
        ...
        <div class="row">
                       ...
                       <!-- 收货信息begin -->
                        <div class="col-sm-6"> 
                              ...
                              <c:if test="${obj.processStatus=='2' || obj.processStatus=='3' || obj.processStatus=='4' || obj.processStatus=='5'}">
	                              <address>
	                              <h3>物流信息 </h3>
	                                <p><strong>物流公司:</strong><span style="padding-left:20px;" ><input type="text" name="expressName"  value="${obj.expressName}" readonly="readonly" /></span></p>
	                                <p><strong>运单号:&nbsp&nbsp&nbsp</strong><span style="padding-left:20px;" ><input type="text" name="expressCode"  value="${obj.expressCode}" readonly="readonly" /></span></p>
	                              </address>
                              </c:if>
                        </div>
 					    <!-- 收货信息end -->
                        ...
                        <tbody>
                            <tr>
                                ...
                                <c:if test="${obj.money3!=null}">
                     			...
                     			¥<fmt:formatNumber type="number" value="${obj.placeOrderMoney}" pattern="0.00" maxFractionDigits="2"/></span></td>
          ...
          <div>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                	<b>摘要</b>:
               <input type="text" id="test" value="" placeholder="选填，100个字以内" style="width:600px;height:40px;" name="abstract"/>
