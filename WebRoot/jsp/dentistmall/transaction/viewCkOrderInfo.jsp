...
<html>
  <head> 
   <title>AI平台系统</title> 
 	...
 	<script src="<c:url value='/javaScript/dentistmall/transaction/viewCkorderInfo.js?v=3'/>"></script>
  </head> 
  <body class="gray-bg">
                    ...
                    <table class="table invoice-total">
                        <tbody>
                            <tr>
                                ...
                                <td style="text-align:center"><strong>入库总数：</strong> <span style="border-bottom: 1px solid #DDDDDD;padding-left:20px; padding-right: 20px;">
