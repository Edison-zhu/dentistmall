...
<div id="top1" style="width:1480px;height: 50px;background-color: #E0E0E0">
    ...
    <div style="width: 100px;margin-left: 30px">订单放款明细</div>
</div>
<span style="font-size: 16px;margin-left: 30px">订单信息</span>
<div id="top2" style="width:1382px;height: 355px;margin-left: 30px;border: 0px solid #F0F0F0">
    <table class="table table-bordered table-hover">
        ...
        <tr>
            ...
            <th style="text-align: center;">服务类型/业务</th>
        </tr>
        </thead>
        <tbody id="mxList">
        </tbody>
...
<div style="font-size: 16px;margin-left: 30px">放款信息</div>
<div id="top3" style="width:1382px;height: 150px;margin-left: 30px;border: 0px solid #F0F0F0">
    <table class="table table-bordered table-hover">
        <thead>
        <tr>
            <th style="text-align: center;">放款状态</th>
...
<div style="text-align: center">
    <a>
        <button type="button" onclick="requestFinance()" class="btn btn-default btn-xs" id="button1"
                style="width: 95px;height: 22px;margin-top: -5px;margin-left: 10px;margin-right: 10px">返回
        </button>
    </a>
</div>
...
<script src="<c:url value='/javaScript/dentistmall/salesman/salesManLoanMx.js?v=3'/>"></script>