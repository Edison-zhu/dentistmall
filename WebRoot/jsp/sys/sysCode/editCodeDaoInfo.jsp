			...
			<div class="panel-body scrollbarinfo">
			   <div class="form-group" styel="">
                ...
                <div class="form-group" styel="">
                    ...
                    <div class="controls col-sm-3">
                      <input type="text" class="form-control" name= "sysClassInfo.SClassName2" id="SClassName2" value="${obj.SClassName2}" placeholder="接口类名称" >
                    </div>
                ...
                <div class="form-group" styel="">
                    ...
                    <div class="controls col-sm-3">
                      <input type="text" class="form-control" name= "sysClassInfo.packagename2" id="packagename2" value="${obj.packagename2}"  placeholder="接口类包名">
                    </div> 
                ...
                <div class="form-group" styel="">
                    ...
                    <div class="controls col-sm-3">
                       <input type="text" class="form-control" name= "sysClassInfo.savepath2" id="savepath2" value="${obj.savepath2}" placeholder="接口类存储路径">
                    </div>                   
                </div> 
                <div class="hr-line-dashed" style="margin-bottom: 2px;    margin-top: 2px;"></div>
                ...
                <div class="form-group" styel="">
                    ...
                    <div class="controls col-sm-3">
                      <input type="text" class="form-control" name= "sysClassInfo.SClassName3" id="SClassName3" value="${obj.SClassName3}" placeholder="持久化对象类名称" >
                    </div>
                  ...
                  <div class="form-group" styel="">
                    ...
                    <div class="controls col-sm-3">
                      <input type="text" class="form-control" name= "sysClassInfo.packagename3" id="packagename3" value="${obj.packagename3}" placeholder="持久化对象类包名" >
                    </div>
...
<script src="<c:url value='/javaScript/sys/syscode/editCodeDaoInfo.js?v=11'/>"></script>