...
<div id="divFilter" class="divFilter">
    ...
    <div class="ibox-content" style="padding: 5px 10px 10px;">
        <form class="form-horizontal" id="win_form_edit_add">
            ...
            <div id="belongTypeDiv" class="form-group" style="margin-bottom:0px;"><label class="col-sm-3 control-label">所属分类<span
                    class="text-danger">(*)</span>：</label>
                <div class="col-sm-8"><input type="text" autocomplete="off" id="belongTypeForm" name="belongType"
                                             class="form-control es-input" placeholder="分类" aria-required="true"
                                             aria-invalid="false">
                    <ul class="es-list"></ul>
                </div>
            </div>
...
<script src="<c:url value='/javaScript/sys/sysparam/unitparam.js?v=17' />"></script>