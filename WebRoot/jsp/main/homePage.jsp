...
<%@ include file="/jsp/link.jsp"%>
  ...
  <script src="<c:url value='/javaScript/dentistmall/transaction/homePage.js?v=29'/>"></script>
  <link rel="stylesheet" href="<c:url value='/css/homePage.css?v=5' />">
  ...
  <body>
    ...
    <div id="containerWhole" style="width:1307px">
    	<div id="container1">
    		<b>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp今天,</b><br/>
    		<span class="newDate"><font size="2px">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<span id="currentDate"></span>,欢迎回来!</span></font>
    		<span class="exportSevenDate"><a onclick="exportSevenDate()" class="btn btn-success  btn-xs">导出七天数据分析</a></span>
    	</div>
    	<div id="container2" style="width:807px;height:180px;margin-left: 27px;" class="container23 con22">
    		<div id="container2Left" class="container2">
    			 ...
    			 <span class="container2Span"><b>累计订单量</b></span>
    		</div>
    		<div id="container2Middle" class="container2">
    			 <img style="float:right" width="90px" height="90px" src="../../../dentistmall/css/shopping/images/container2Middle.png">
    			 <span class="container2Span" id="placeOrderMoneys"></span></br></br>
    			 <span class="container2Span"><b>累计订单总额</b></span>
    		</div>
    		<div id="container2Right" class="container2">
    			 <img style="float:right;margin-right: 12px;" width="90px" height="90px" src="../../../dentistmall/css/shopping/images/container2Right.png">
    			 <span class="container2Span" id="RetreatPlaceOrderMoney"></span></br></br>
    			 <span class="container2Span"><b>累计退款金额</b></span>
    		</div>
    	</div>
