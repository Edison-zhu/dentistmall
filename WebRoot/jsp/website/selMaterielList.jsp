			...
			<div class="panel-body scrollbarinfo">
				...
				<div class="form-inline form-group">
					<div class="controls col-sm-5" style="font-size:15px">
						商品名称:
						<input type="text" class="form-control" placeholder="商品名称" name="matName" value="" style="width:120px">
					</div>
					<div class="controls col-sm-5" style="font-size:15px">
						供应商名称:
...
<script src="<c:url value='/javaScript/website/selMaterielList.js?v=3'/>"></script>