 ...
 * 
 *                                        （使用JDK的ZipEntry存在文件名中文乱码问题，用apache-
 *                                        tools的则不会）
 * 
 * @author
 */
public class ZipUtil {
    ...
    public static void main(String[] args){  
        String sourceFilePath = "D:\\svn_data\\temp";  
        String zipFilePath = "D:\\svn_data";  
        String fileName = "12700153file";  
        
        	//ZipUtil.zipFiles(sourceFilePath, zipFilePath+"\\"+fileName+".zip");
        	com.hsk.xframe.api.utils.freeMarker.ZipUtil.unZipFiles( zipFilePath+"\\"+fileName+".zip","D:\\svn_data\\temp1");
