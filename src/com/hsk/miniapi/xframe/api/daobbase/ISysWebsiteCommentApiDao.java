 ...
 *
 */
public interface ISysWebsiteCommentApiDao {
	/**
	 * 添加一条内容信息记录的Dao方法
	 * 
	 * @param mxxzAccount
    ...
    List<SysWebsiteComment> findPagerModelSysWebsiteCommentByIdNoLogin(Integer swcId, Integer number) throws HSKDBException;
}
