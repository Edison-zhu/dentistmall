package com.hsk.miniapi.xframe.web.sysnotice.service.impl;
...
import com.hsk.miniapi.xframe.api.daobbase.ISysNoticeInfoApiDao;
...
*/
@Service
public class SysNoticeInfoApiService extends DSTApiService implements ISysNoticeInfoApiService {
	/**
	   *业务处理dao类  sysNoticeInfoDao 
	   */
		@Autowired
		protected ISysNoticeInfoApiDao sysNoticeInfoDao;
