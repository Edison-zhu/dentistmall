...
import com.hsk.miniapi.xframe.api.daobbase.ISysWebsiteColumnsApiDao;
...
import com.hsk.miniapi.xframe.api.utils.freeMarker.CreateCodeUtil;
...
@Service
public class SysWebsiteColumnsApiService extends DSTApiService implements ISysWebsiteColumnsApiService {
	
	@Autowired
	private ISysWebsiteColumnsApiDao sysWebsiteColumnsDao;
	@Autowired
