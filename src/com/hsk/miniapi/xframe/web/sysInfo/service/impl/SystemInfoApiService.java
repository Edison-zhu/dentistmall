package com.hsk.miniapi.xframe.web.sysInfo.service.impl;
import java.io.File;
...
import com.hsk.miniapi.xframe.web.sysInfo.service.ISystemInfoApiService;
import com.hsk.miniapi.xframe.web.sysModelObject.service.IModelObjectApiService;

@Service
public class SystemInfoApiService extends DSTApiService implements ISystemInfoApiService {
	@Autowired
	private ISysSystemInfoApiDao sysSystemInfoDao;

	@Autowired
	private IModelObjectApiService modelObjectService;
