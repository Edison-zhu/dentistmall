package com.hsk.miniapi.xframe.web.sysModelObject.service.imp;
...
@Service
public class ModelObjectApiService extends SupperService implements
		IModelObjectApiService {
	@Autowired
