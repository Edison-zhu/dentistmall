package com.hsk.miniapi.dentistmall.web.evaluate.service.imp;
...
import com.hsk.miniapi.dentistmall.web.evaluate.service.*;
...
@Service
public class MdEvaluateApiService extends DSTApiService implements IMdEvaluateApiService {
   /**
   *业务处理dao类  mdEvaluateDao 
   */
	@Autowired
	protected IMdEvaluateApiDao mdEvaluateDao;
