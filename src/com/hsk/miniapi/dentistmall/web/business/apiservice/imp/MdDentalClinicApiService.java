...
import com.hsk.miniapi.dentistmall.web.business.apiservice.*;
...
@Service
public class MdDentalClinicApiService extends DSTApiService implements IMdDentalClinicApiService {
   /**
 ...
 /**
	 ...
	 */
	public SysRetrunMessage saveOrUpdateObject(MdDentalClinic att_MdDentalClinic)
			throws HSKException {
		SysRetrunMessage srm = new SysRetrunMessage(1l);
		try {
			Integer orgid = 1;
