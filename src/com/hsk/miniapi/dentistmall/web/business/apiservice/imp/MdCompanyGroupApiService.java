...
import com.hsk.miniapi.dentistmall.web.business.apiservice.IMdCompanyGroupApiService;
...
@Service
public class MdCompanyGroupApiService extends DSTApiService implements IMdCompanyGroupApiService {
   /**
   ...
   */
	...
	@Autowired
	protected ISysSalesmanApiDao sysSalesmanDao;
 ...
 /**
	 ...
	 */
	public SysRetrunMessage saveOrUpdateObject(MdCompanyGroup att_MdCompanyGroup)
			throws HSKException {
		SysRetrunMessage srm = new SysRetrunMessage(1l);
		try {
			Integer orgid = 1;
