...
import com.hsk.dentistmall.api.persistence.MdEnclosure;
import com.hsk.miniapi.dentistmall.web.business.apiservice.IMdEnclosureApiService;
...
@Service
public class MdEnclosureApiService extends DSTApiService implements IMdEnclosureApiService {
	/**
	 *业务处理dao类  mdEnclosureDao
	 */
	@Autowired
	protected IMdEnclosureApiDao mdEnclosureDao;
	...
	public SysRetrunMessage findFormObject(Integer rbenId) throws HSKException{
		...
		try{
			com.hsk.dentistmall.api.persistence.MdEnclosure att_MdEnclosure= mdEnclosureDao.findMdEnclosureById( rbenId) ;
	...
	public com.hsk.dentistmall.api.persistence.MdEnclosure findObject(Integer rbenId) throws HSKException{
		com.hsk.dentistmall.api.persistence.MdEnclosure att_MdEnclosure=new com.hsk.dentistmall.api.persistence.MdEnclosure();
		try{
	 ...
	 */
	public SysRetrunMessage saveOrUpdateObject( com.hsk.dentistmall.api.persistence.MdEnclosure att_MdEnclosure) throws HSKException{
		SysRetrunMessage srm = new SysRetrunMessage(1l);
		try{
	 ...
	 * @throws HSKException
	 */
	public PagerModel getPagerModelObject (com.hsk.dentistmall.api.persistence.MdEnclosure att_MdEnclosure) throws HSKException{
