...
*/
@Service
public class MdMaterielTypeApiService extends DSTApiService implements IMdMaterielTypeApiService {
	/**
		...
		public List<Map<Object, Object>> getTreeListByMdMmtId(Integer id)throws HSKException {
			...
			try {
				...
				if (sysUserInfo == null && sysSwitchEntity != null && Objects.equals(sysSwitchEntity.getState(), 1)) {
					List<Map<Object, Object>> list = mdMaterielTypeDao.getTreeListByMdMmtIdNoLogin(id);
