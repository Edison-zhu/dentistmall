...
public interface IMdMaterielFormatApiDao {
	/**
	 ...
	 * @throws HSKDBException
	 */
    List<MdMaterielFormat> findMdMaterielFormatByMffCode(String mmfCode) throws HSKDBException;

    List<MdMaterielFormatTemp> getListByMdMaterielFormatNoLogin(MdMaterielFormatTemp att_mdMaterielFormat) throws HSKDBException;
}
