...
import com.hsk.miniapi.dentistmall.api.daobbase.IMdMaterielTypeApiDao;
 ...
 */
@Component
public class MdMaterielTypeApiDao extends SupperDao implements IMdMaterielTypeApiDao {
	...
	@Override
	public List<Map<Object, Object>> getTreeListByMdMmtIdNoLogin(Integer mdMmtId) throws HSKDBException {
		List<Map<Object, Object>> reList = new ArrayList<Map<Object, Object>>();
		String sql = "select a.mmt_id,a.mmt_name,(select count(1) from md_materiel_type_temp b where b.md_mmt_id=a.mmt_id) as shu from md_materiel_type_temp a where 1=1";
		if(mdMmtId != null && mdMmtId >0)
			sql += " and a.md_mmt_id="+mdMmtId +" order by mmt_id";
		else
			sql += " and (a.md_mmt_id is null or a.md_mmt_id=0) order by mmt_id";
