 ...
 */
@Component
public class MdSupplierApiDao extends SupperDao implements IMdSupplierApiDao {
	...
	@Override
	public PagerModel getPagerModelByMdSupplierSearchNoLogin(String searchName, String state) throws HSKDBException {
		String hql ="from MdSupplierTemp where state='"+state+"'";
