 ...
 */
public interface IMdEnterWarehouseMxService{
	...
	public SysRetrunMessage   saveOrUpdateObject( MdEnterWarehouse att_MdEnterWarehouse, String wewMxIds, Integer moiIds, String mmfIds,String momIds,String shus,String number1s,
												  ...
												  String certnos, String masIds, String retailPrices, String units, String splitNumbers, String backPrintings,String linkmmfIds,String linkwmsIds,
												  String ratio1s) throws HSKException;
	...
	PagerModel getMdEnterWarehouseMxListByWewId(Integer wewId, String str, Integer wowId, Integer wiId) throws HSKException;
}