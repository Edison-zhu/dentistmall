 ...
 */
public interface IMdOutWarehouseMxService{
	 ...
	 * @throws HSKException
	 */
	public PagerModel getMdOutWarehouseMxListByMoiId(Integer wowId, Integer mooId)  throws HSKException;
	/**
	 * 根据物料明细ID查询本单位出库明细信息
	 * @param mmfId
	 * @return
	...
	PagerModel getMdEnterWarehouseByWowId(Integer wowId, String str) throws HSKException;
}