 ...
 */
@Service
public class MdOrderAfterSaleService extends DSTService implements IMdOrderAfterSaleService {
    ...
    @Override
    public SysRetrunMessage getMdOrderSaleAfterByMasId(Integer masId) throws HSKException {
        SysRetrunMessage sm = new SysRetrunMessage(1l);
        try {
