...
@Service
public class  MdSupplierService extends DSTService implements IMdSupplierService {	
   /**
			 ...
			 SysRetrunMessage srm = new SysRetrunMessage(1l);
			  try{
				  ...
				  orgid = (sui != null) ? (sui.getOrgGxId() != null ? (sui.getOrgGxId())
					...
					if (att_MdSupplier.getSalesmanIds() != null && !att_MdSupplier.getSalesmanIds().equals("")) {
						att_MdSupplier.setSalesmanTime(new Date());
					}
