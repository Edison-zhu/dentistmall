 ...
 */
public interface IMdEnterWarehouseMxDao{
	...
	PagerModel getMdEnterwarehousemxMaterielEntityByMdEnterWarehouseMx(MdEnterWarehouseMx att_mdEnterWarehouseMx) throws HSKDBException;
	/**
	 * 查询入库明细分页信息
    ...
    List<MdInventoryExtend> getInventoryListByWewMxId(MdEnterWarehouseMx mdEnterWarehouseMx) throws HSKDBException;
	List<MdInventoryExtend> getInventoryListByWewId(MdEnterWarehouseMx mdEnterWarehouseMx) throws HSKDBException;

	Double getEnterMxExpectNumber(MdEnterWarehouse mdEnterWarehouse) throws HSKDBException;

	Double getEnterMxPurchasePeice(MdEnterWarehouse mdEnterWarehouse) throws HSKDBException;

	Double getEnterMxRetailMoeny(MdEnterWarehouse mdEnterWarehouse) throws HSKDBException;
}