 ...
 */
@Component
public class  MdEnclosureDao extends SupperDao implements IMdEnclosureDao {	
	...
	public List<MdEnclosure> getListByMdEnclosure(MdEnclosure att_MdEnclosure) throws HSKDBException{
		String Hql=this.getHql( att_MdEnclosure); 
	 ...
	 *  @return hql字符串
	 */
	private String  getHql(MdEnclosure att_MdEnclosure){
			 StringBuffer sbuffer = new StringBuffer( " from  MdEnclosure  where  1=1  ");
