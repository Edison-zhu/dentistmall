...
@Component
public class MDCartsDao extends SupperDao implements IMdCartsDao{
	...
	@Override
	public void deleteMdCartsBySuiIdsAndMfIds(Integer sui_id, Integer mmfIds) throws HSKDBException {
...
//		}
	...
	public List<Map<String, Object>> getPurchasedInfoList(Integer mmfId,Integer suiId,String matNameAndCode,Integer limit,Integer page,Integer date1) throws HSKDBException{
		String sql=" SELECT t2.mat_name,t1.mmf_name,t1.mmf_code,t1.price,t2.wms_mi_id,t1.mmf_id,t2.Basic_unit,t3.edit_date,t2.state,(SELECT t4.root_path FROM sys_file_info t4 WHERE t4.file_code=t2.lessen_filecode ) AS lessenFilecode  FROM md_materiel_format t1 LEFT JOIN md_materiel_info t2 ON t1.wms_mi_id=t2.wms_mi_id LEFT JOIN md_purchased t3 ON t1.mmf_id=t3.mmf_id WHERE 1=1";
		if (suiId!=null){
			sql+="  AND sui_id="+suiId;
		}
