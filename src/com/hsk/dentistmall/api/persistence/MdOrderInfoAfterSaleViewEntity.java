 ...
 */
@Entity
@Table(name = "md_order_info_after_sale_view")
public class MdOrderInfoAfterSaleViewEntity {
    ///===============数据库表字段属性begin==========
    /**
...
///===============数据库表无关子段字段属性begin==========
    ...
    @Column(name = "as_create")
    public Date getAsCreate() {
        return asCreate;
    }

    public void setAsCreate(Date asCreate) {
