...
import com.hsk.xframe.web.webSite.service.ISysWebsiteInfoService;

/**
 * 网站信息业务实现类
 */
@Service
public class SysWebsiteInfoService extends DSTService implements ISysWebsiteInfoService {

	@Autowired
	private ISysWebsiteInfoDao sysWebsiteInfoDao;
	@Autowired
