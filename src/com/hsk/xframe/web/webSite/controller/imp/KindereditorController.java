package com.hsk.xframe.web.webSite.controller.imp;
...
import com.hsk.xframe.web.webSite.controller.IKindeditorController;

@Controller
public class KindereditorController extends DSTController  implements
		IKindeditorController {
	private final String att_dirName = "KinderEditor";

	@RequestMapping(value = "/jsp/file_manager_json.htm")
...
//			String showUrl=saveUrl.substring(saveUrl.indexOf("webapps")+7)+newFileName;
	...
	@RequestMapping(value = "/jsp/upload_json.htm")
