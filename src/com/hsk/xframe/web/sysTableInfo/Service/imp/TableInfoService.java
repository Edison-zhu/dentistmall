package com.hsk.xframe.web.sysTableInfo.Service.imp;
...
import com.hsk.xframe.web.window.RunSrc;

@Service
public class TableInfoService extends DSTService implements ITableInfoService {

	private static final ICodeAutoService tableSer = null;

	@Autowired
	private ITablesInfoDao tablesInfoDao;

	@Autowired
	private IFieldInfoDao fieldInfoDao;

	@Autowired
	private ICodeAutoService codeAutoService;
