 ...
 */
@Repository
public class SysMenuInfoDao extends SupperDao implements ISysMenuInfoDao {
	...
	public int getMaxOrderByParentId(Integer smenuId) throws HSKDBException {
		int re =0;
		String sql = "SELECT MAX(menu_order_code) AS shu FROM sys_menu_info WHERE 1=1 ";
		if (smenuId != null)
			sql += " and sys_smenu_id='"+smenuId+"'";
		else
			sql += " and menu_order_code <> 99";
