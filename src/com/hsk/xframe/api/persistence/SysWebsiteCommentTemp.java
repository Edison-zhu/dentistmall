...
@Entity
@Table(name = "sys_websit_comment_temp")
public class SysWebsiteCommentTemp implements java.io.Serializable {

	// Fields

	public SysWebsiteCommentTemp(Integer swmId, Integer swcId, String state,
	...
	/** default constructor */
	public SysWebsiteCommentTemp() {
	}

	/** minimal constructor */
	public SysWebsiteCommentTemp(Integer swmId) {
		this.swmId = swmId;
	}
	...
	@Formula("(SELECT a.root_path FROM sys_file_info_temp a WHERE a.file_code= news_icon_fileCode)")
	...
	@Formula("(SELECT a.root_path FROM sys_file_info_temp a WHERE a.file_code= News_illustrated_fileCode)")
